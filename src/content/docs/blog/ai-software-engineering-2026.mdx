...
heroImage: /images/bk-ai.webp
---

import Comments from '../../../components/Comments.astro';

{/* no-enhance */}
<img src="/images/bk-ai.webp" alt="AI in Software Engineering" style="float: right; max-width: 200px; margin: 0 0 1.5rem 2rem;" loading="lazy" />
